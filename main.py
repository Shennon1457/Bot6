...
from keyboards.key_in import key1, key2
...
async def start(message: types.Message):
    await message.reply('Привет ты на клавиатуре 1, нажми кнопку, чтобы перейти на виды военных самолётов', reply_markup=key1())
